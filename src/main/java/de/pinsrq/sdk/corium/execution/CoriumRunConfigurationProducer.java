...
public class CoriumRunConfigurationProducer extends RuntimeConfigurationProducer {
    public CoriumRunConfigurationProducer() {
        super(CoriumRunConfigurationType.getInstance());
    }
