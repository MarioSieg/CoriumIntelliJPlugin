...
public class CoriumFileTemplates {

    private CoriumFileTemplates() { }

    private final static String CORIUM_TEMPLATE_PREFIX = "Corium ";

    public static List<FileTemplate> getApplicableTemplates() {
        return getApplicableTemplates(fileTemplate -> CoriumFileType.INSTANCE.getDefaultExtension().equals(fileTemplate.getExtension()));
    }
    ...
    public static String getTemplateShortName(String templateName) {
        if (templateName.startsWith(CORIUM_TEMPLATE_PREFIX)) {
            return templateName.substring(CORIUM_TEMPLATE_PREFIX.length());
        }
        return templateName;
    }
}