...
public class CoriumParameterImpl extends ASTWrapperPsiElement implements CoriumParameter {

  public CoriumParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CoriumTypeName getTypeName() {
    return findNotNullChildByClass(CoriumTypeName.class);
  }
