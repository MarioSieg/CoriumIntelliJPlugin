...
public class CoriumParenthesisExpressionImpl extends CoriumExpressionImpl implements CoriumParenthesisExpression {

  public CoriumParenthesisExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
